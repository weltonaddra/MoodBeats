...
inline const int marioDurations[] = {
  8,8,8,8,8,8,8,
  4,4,8,4,
  4,8,4,4,
  4,4,8,4,
...
inline const int marioSize = sizeof(marioNotes) / sizeof(marioNotes[0]);
// sizeof(marioNotes) / sizeof(marioNotes[0]);
